...
const BLOG = {
  ...
  NOTION_PAGE_ID:
      process.env.NOTION_PAGE_ID || 'f9271589b5114876b581a4d4b2345d8a',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是不单星球的创始人,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ACSky', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '在这个星球的经历只是旅程的片段', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ju.link', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Bot, 博客', // 网站关键词 英文逗号隔开
